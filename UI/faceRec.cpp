...
void FaceRec::displayImage(int, QImage image)
{
    ...
    ui->label->setPixmap(QPixmap::fromImage(image).scaled(400,225, Qt::KeepAspectRatio, Qt::SmoothTransformation));//调整图片大小
    //ui->v_layout->removeWidget(viewfinder);
    viewfinder->hide();
