...
public:
    ...
    {
        Output->setWindowTitle(QApplication::translate("Output", "Decklink Output", nullptr));
        label->setText(QApplication::translate("Output", "Output", nullptr));
        outputButton->setText(QApplication::translate("Output", "Start", nullptr));
        label_2->setText(QApplication::translate("Output", "Preview Output", nullptr));
        previewOutputButton->setText(QApplication::translate("Output", "Start", nullptr));
        keyerLabel->setText(QApplication::translate("Output", "Keyer output requires RGB mode in advanced settings.", nullptr));
    } // retranslateUi
