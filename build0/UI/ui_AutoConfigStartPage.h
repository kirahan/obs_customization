...
public:
    ...
    {
        prioritizeStreaming->setText(QApplication::translate("AutoConfigStartPage", "Basic.AutoConfig.StartPage.PrioritizeStreaming", nullptr));
        prioritizeRecording->setText(QApplication::translate("AutoConfigStartPage", "Basic.AutoConfig.StartPage.PrioritizeRecording", nullptr));
        label_2->setText(QApplication::translate("AutoConfigStartPage", "Basic.AutoConfig.Info", nullptr));
        label->setText(QApplication::translate("AutoConfigStartPage", "Basic.AutoConfig.RunAnytime", nullptr));
