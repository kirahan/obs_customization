...
public:
    ...
    {
        finalResultLabel->setText(QApplication::translate("AutoConfigTestPage", "Basic.AutoConfig.TestPage.Result.Header", nullptr));
        finalResultLabel_2->setText(QApplication::translate("AutoConfigTestPage", "Basic.AutoConfig.TestPage.Result.Footer", nullptr));
