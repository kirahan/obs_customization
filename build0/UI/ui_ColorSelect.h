...
"}"));
    ...
    {
        ColorSelect->setWindowTitle(QApplication::translate("ColorSelect", "Form", nullptr));
        preset1->setText(QString());
        preset1->setProperty("preset", QVariant(QApplication::translate("ColorSelect", "1", nullptr)));
        preset2->setText(QString());
        preset2->setProperty("preset", QVariant(QApplication::translate("ColorSelect", "2", nullptr)));
        preset3->setText(QString());
        preset3->setProperty("preset", QVariant(QApplication::translate("ColorSelect", "3", nullptr)));
        preset4->setText(QString());
        preset4->setProperty("preset", QVariant(QApplication::translate("ColorSelect", "4", nullptr)));
        preset5->setText(QString());
        preset5->setProperty("preset", QVariant(QApplication::translate("ColorSelect", "5", nullptr)));
        preset6->setText(QString());
        preset6->setProperty("preset", QVariant(QApplication::translate("ColorSelect", "6", nullptr)));
        preset7->setText(QString());
        preset7->setProperty("preset", QVariant(QApplication::translate("ColorSelect", "7", nullptr)));
