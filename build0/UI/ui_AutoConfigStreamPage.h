...
public:
    ...
    {
        serviceLabel->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.Service", nullptr));
        moreInfoButton->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.MoreInfo", nullptr));
        connectAccount->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.ConnectAccount", nullptr));
        useStreamKey->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.UseStreamKey", nullptr));
        serverLabel->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.Server", nullptr));
        streamKeyLabel->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.StreamKey", nullptr));
        show->setText(QApplication::translate("AutoConfigStreamPage", "Show", nullptr));
        streamKeyButton->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.GetStreamKey", nullptr));
        bitrateLabel->setText(QApplication::translate("AutoConfigStreamPage", "Basic.Settings.Output.VideoBitrate", nullptr));
#ifndef QT_NO_TOOLTIP
        preferHardware->setToolTip(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.PreferHardwareEncoding.ToolTip", nullptr));
#endif // QT_NO_TOOLTIP
        preferHardware->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.PreferHardwareEncoding", nullptr));
        doBandwidthTest->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.PerformBandwidthTest", nullptr));
        region->setTitle(QApplication::translate("AutoConfigStreamPage", "BandwidthTest.Region", nullptr));
        regionAsia->setText(QApplication::translate("AutoConfigStreamPage", "BandwidthTest.Region.Asia", nullptr));
        regionUS->setText(QApplication::translate("AutoConfigStreamPage", "BandwidthTest.Region.US", nullptr));
        regionEU->setText(QApplication::translate("AutoConfigStreamPage", "BandwidthTest.Region.EU", nullptr));
        regionOther->setText(QApplication::translate("AutoConfigStreamPage", "BandwidthTest.Region.Other", nullptr));
        connectAccount2->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.ConnectAccount", nullptr));
        disconnectAccount->setText(QApplication::translate("AutoConfigStreamPage", "Basic.AutoConfig.StreamPage.DisconnectAccount", nullptr));
