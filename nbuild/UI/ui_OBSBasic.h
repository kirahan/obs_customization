...
public:
    ...
    void setupUi(QMainWindow *OBSBasic)
    {
        ...
        hVolumeWidgets->setGeometry(QRect(0, 0, 89, 16));
        ...
        courseDock = new QDockWidget(OBSBasic);
        courseDock->setObjectName(QString::fromUtf8("courseDock"));
        dockWidgetContents = new QWidget();
        dockWidgetContents->setObjectName(QString::fromUtf8("dockWidgetContents"));
        gridLayout = new QGridLayout(dockWidgetContents);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        courseList = new QListWidget(dockWidgetContents);
        courseList->setObjectName(QString::fromUtf8("courseList"));

        gridLayout->addWidget(courseList, 0, 0, 1, 1);

        courseDock->setWidget(dockWidgetContents);
        OBSBasic->addDockWidget(Qt::LeftDockWidgetArea, courseDock);
    ...
    void retranslateUi(QMainWindow *OBSBasic)
    {
        ...
        courseDock->setWindowTitle(QCoreApplication::translate("OBSBasic", "\350\257\276\347\250\213\345\210\227\350\241\250", nullptr));
    } // retranslateUi
